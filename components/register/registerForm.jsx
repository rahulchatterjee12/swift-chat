    ...
    return (
        <div className='flex items-center justify-center h-screen'>
            <form onSubmit={handleSubmit} className='min-h-[30vh] bg-white w-[95vw] md:w-[35vw] rounded-lg shadow-md p-5'>
                ...
                <div className="flex items-center space-y-2 my-2 justify-between px-6 py-2 border border-gray-300 rounded-md">
                    <div className='relative'>
                        <img src={avatarUrl} alt="" className='rounded-full h-20 w-20' />
                    </div>
                    <Button sx={{ textTransform: 'none', color: 'gray', borderColor: 'gray' }} variant='outlined' color='inherit' onClick={handleRefreshAvatar}>New Avatar</Button>
                </div>
                ...
                <Button size='small' sx={{ marginBottom: 1 }} fullWidth variant='contained' color='inherit' type="submit">Register</Button>
